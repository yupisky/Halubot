...
from halubot import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS, BAN_STICKER, spamfilters, MAPS_API
from halubot.__main__ import STATS, USER_INFO
from halubot.modules.disable import DisableAbleCommandHandler
from halubot.modules.helper_funcs.extraction import extract_user
from halubot.modules.helper_funcs.filters import CustomFilters
from halubot.modules.helper_funcs.msg_types import get_message_type
from halubot.modules.helper_funcs.misc import build_keyboard_alternate

from halubot.modules.languages import tl
from halubot.modules.sql import languages_sql as lang_sql
import halubot.modules.sql.feds_sql as feds_sql
...
RUN_STRINGS = (
    ...
    "Hei, lihat mereka! Mereka berlari dari Halubot yang tak terelakkan ... Lucu sekali 😂",
