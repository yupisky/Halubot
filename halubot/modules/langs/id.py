...
Gabung grup [Halubot Official Support](https://t.me/Temengoblok)!
...
# Help modules
	"language_help": """Tidak semua grup berbicara bahasa Indonesia; beberapa grup lebih suka Halubot menanggapi dalam bahasa mereka sendiri.

Di sinilah terjemahan masuk; Anda dapat mengubah sebagian besar balasan Halubot menjadi bahasa pilihan Anda!
...
""",
	"backups_help": """
*Hanya admin:*
 - /import: balas ke file cadangan grup butler/marie/rose/halubot untuk mengimpor sebanyak mungkin, membuat transfer menjadi sangat mudah! \
 Catatan bahwa file/foto tidak dapat diimpor karena pembatasan telegram. Kecuali backup dari Halubot.
...
RAMALAN_STRINGS = (
	...
	"Anda akan mengalami kejadian aneh hari ini.\nDan itu tidak termasuk mendapatkan ramalan dari Halubot 😜",
	"Akhirnya ada kesempatan untuk beristirahat...\ndan mendengar ramalan dari Halubot 😉",
