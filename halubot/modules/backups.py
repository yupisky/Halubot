...
import halubot.modules.sql.notes_sql as sql
from halubot import dispatcher, LOGGER, OWNER_ID, SUDO_USERS, spamfilters, TEMPORARY_DATA
from halubot.__main__ import DATA_IMPORT
from halubot.modules.helper_funcs.chat_status import user_admin
from halubot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from halubot.modules.helper_funcs.msg_types import get_note_type
from halubot.modules.rules import get_rules
from halubot.modules.helper_funcs.string_handling import button_markdown_parser, make_time

# SQL
import halubot.modules.sql.antiflood_sql as antifloodsql
import halubot.modules.sql.blacklist_sql as blacklistsql
import halubot.modules.sql.blsticker_sql as blackliststksql
from halubot.modules.sql import disable_sql as disabledsql
from halubot.modules.sql import cust_filters_sql as filtersql
from halubot.modules.sql import languages_sql as langsql
import halubot.modules.sql.locks_sql as locksql
from halubot.modules.locks import LOCK_TYPES, RESTRICTION_TYPES
from halubot.modules.sql import notes_sql as notesql
from halubot.modules.sql import reporting_sql as reportsql
import halubot.modules.sql.rules_sql as rulessql
from halubot.modules.sql import warns_sql as warnssql
import halubot.modules.sql.welcome_sql as welcsql

from halubot.modules.connection import connected

from halubot.modules.helper_funcs.msg_types import Types
from halubot.modules.languages import tl
from halubot.modules.helper_funcs.alternate import send_message
...
def import_data(bot: Bot, update):
	...
	if msg.reply_to_message and msg.reply_to_message.document:
		...
		try:
			# If backup is from Halubot
			if data.get('bot_base') == "Halubot":
				imp_antiflood = False
				imp_blacklist = False
			...
			send_message(update.effective_message, tl(update.effective_message, "Telah terjadi kesalahan dalam import backup Halubot!\nGabung ke [Grup support](https://t.me/joinchat/Fykz0VTMpqZvlkb8S0JevQ) kami untuk melaporkan dan mengatasi masalah ini!\n\nTerima kasih"), parse_mode="markdown")
			LOGGER.exception("An error when importing from Halubot base!")
			return
...
def export_data(bot: Bot, update: Update, chat_data):
	...
	f = open("{}-Halubot.backup".format(chat_id), "w")
	...
	try:
		...
		pass
	os.remove("{}-Halubot.backup".format(chat_id)) # Cleaning file
