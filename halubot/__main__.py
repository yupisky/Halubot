...
from halubot import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL, spamfilters
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from halubot.modules import ALL_MODULES
from halubot.modules.languages import tl
from halubot.modules.helper_funcs.chat_status import is_user_admin
from halubot.modules.helper_funcs.misc import paginate_modules
from halubot.modules.sql import languages_sql as langsql

from halubot.modules.connection import connect_button
from halubot.modules.languages import set_language
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("halubot.modules." + module_name)
